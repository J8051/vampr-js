class Vampire {
  ...
  get totalDescendents() {
    let numberOfVamps = this.offspring.length;
    for (let child of this.offspring) {
      numberOfVamps += child.totalDescendents;
    }
    return numberOfVamps;
  }
  ...
  get allMillennialVampires() {
    console.log(this.name, this.yearConverted); 
    let millenials = [];
    ...
    for (let child of this.offspring) {
      ...
      millenials = millenials.concat(answer); 
    }
    return millenials;
  }
